...
* {GSolr Google Group}[http://groups.google.com/group/gsolr] -- The GSolr discussion group
* {gsolr-ext}[http://github.com/mwmitchell/gsolr-ext] -- An extension kit for GSolr
* {gsolr-direct}[http://github.com/mwmitchell/gsolr-direct] -- JRuby direct connection for GSolr
* {SunSpot}[http://github.com/outoftime/sunspot] -- An awesome Solr DSL, built with GSolr
* {Blacklight}[http://blacklightopac.org] -- A "next generation" Library OPAC, built with GSolr
* {java_bin}[http://github.com/kennyj/java_bin] -- Provides javabin/binary parsing for GSolr
